...
import com.application.jetbill.dto.PurchaseItemCreateDTO;
import com.application.jetbill.dto.PurchaseItemDTO;
import com.application.jetbill.model.entity.Book;
import com.application.jetbill.model.entity.Purchase;
import com.application.jetbill.model.entity.PurchaseItem;
...
public class PurchaseMapper {
    ...
    public PurchaseDTO toPurchaseDTO(Purchase purchase){
        ...
        //purchaseDTO.setUserName(purchase.getUser().+" "+purchase.getCustomer().getLastName());
